...
<?php 
	...
	echo '</table>
				...
				<p>Silahkan klik tombol <strong>Terima</strong> jika ingin memilih <strong>'.$nama_mhs.'</strong> sebagai Asisten. Pastikan beban jam kerja yang dimiliki oleh mahasiswa tersebut masih memadai.</p>
