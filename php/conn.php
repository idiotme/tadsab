...
function connect(){	
	...
	if(!$database = pg_connect("host=$dbhost port=$port dbname=$dbname user=$dbuser password=$dbpass")) //syntax php koneksi ke DBMS PGSQL dengan parameter sesuai variable diatas
